--do return end
-- Quarry.lua v20201108 (19 JF12 Fuel Qube)
...
tDiffs.uSW = fMP(-1 * iSpacing, iSpacing, -1 * iSpacing)
tDiffs.uSE = fMP(iSpacing, iSpacing, -1 * iSpacing)
tDiffs.uNW = fMP(-1 * iSpacing, iSpacing, iSpacing)
tDiffs.uNE = fMP(iSpacing, iSpacing, iSpacing)
tDiffs.dSW = fMP(-1 * iSpacing, -1 * iSpacing, -1 * iSpacing)
tDiffs.dSE = fMP(iSpacing, -1 * iSpacing, -1 * iSpacing)
tDiffs.dNW = fMP(-1 * iSpacing, -1 * iSpacing, iSpacing)
tDiffs.dNE = fMP(iSpacing, -1 * iSpacing, iSpacing)
